...
const initialEvents: scheduleEvent[] = [
    ...
    { id: 4, date: new Date(new Date().setHours(8, 0, 0, 0)), title: 'Eat Breakfast', type: 'Routine', color: 'text-gray-700' },
    { id: 5, date: new Date(new Date().setHours(9, 0, 0, 0)), title: 'Take Morning Meds', type: 'Medication', color: `text-[${ORANGE_ACCENT}]` },
    { id: 6, date: new Date(new Date().setHours(11, 0, 0, 0)), title: 'Nurse Arrives', location: 'Home', type: 'Doctor', color: `text-[${BLUE_ACCENT}]` },
    { id: 7, date: new Date(new Date().setHours(12, 30, 0, 0)), title: 'Eat Lunch', type: 'Routine', color: 'text-gray-700' },
    { id: 8, date: new Date(new Date().setHours(16, 0, 0, 0)), title: 'Read or Nap', type: 'Routine', color: 'text-gray-500' },
    { id: 9, date: new Date(new Date().setHours(18, 0, 0, 0)), title: 'Eat Dinner', type: 'Routine', color: 'text-gray-700' },
    { id: 10, date: new Date(new Date().setHours(20, 30, 0, 0)), title: 'Take Evening Meds', type: 'Medication', color: `text-[${ORANGE_ACCENT}]` },
    { id: 11, date: new Date(new Date().setHours(22, 0, 0, 0)), title: 'Go to Bed', type: 'Routine', color: 'text-gray-700' },
];
